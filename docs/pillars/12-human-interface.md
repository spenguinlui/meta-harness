# 支柱 12：Human Interface

target repo 跑出來的東西**給誰看**。和「給工程師 / 系統看」的支柱 9 觀測對稱——支柱 9 是 system-facing IO 邊界，支柱 12 是 **human-facing** IO 邊界。
